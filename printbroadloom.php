...
<body>
    ...
    <div class="container mt-5 mb-5">
        <h1 class="fw-bold mb-5">Print Broadloom Collection</h1>
        <div class="row g-4">
            <?php
            $result = $conn->query("SELECT id, style_name, photo, in_stock, on_sale  FROM print_broadloom");
            ...
            ?>
                    <div class="col-md-4 col-sm-6">
                        <div class="product-card">
                            ...
                            <a href="item_details.php?id=<?= $item['id'] ?>&type=Print Broadloom Collection" class="view-btn">View</a>
                        </div>
